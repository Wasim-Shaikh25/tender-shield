...
| TS-085 | Workspace/tenant: multi-workspace selection and switcher | audit F06 | `specs/900-production-readiness-audit-fixes.md`, `specs/modules/auth.md` | in-progress |
