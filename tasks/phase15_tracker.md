...
|--------|-------|-------|--------|
| 0 | Data quality | TS-054 Risk Explainability, TS-055 Structured Review Outcomes | todo |
...
| TS-054 | Risk Explainability | `risk` + frontend | P0 — input | todo | `explanation` object on every finding, rendered in UI | core `Finding` contract change |
| TS-055 | Structured Review Outcomes | `review` | P0 — input | todo | New `NEEDS_CLARIFICATION`/`FALSE_POSITIVE` states, rejection reasons, audit logging | core `ReviewStatus` change |
