...
| TS-094 | Production virus scanning: replace stub with ClamAV or cloud scanner | `PRODUCTION_READINESS_AUDIT.md` F29; Doc §11.2 | `specs/901-post-audit-remaining-fixes.md` | todo |
| TS-095 | End-to-end validation bug fixes: Settings loads .env.local, workspace list shape, switch_workspace refresh persistence, login email_verified response | `PRODUCTION_READINESS_AUDIT.md` follow-up; test report | `specs/901-post-audit-remaining-fixes.md` | done |
| TS-096 | Rulepack validation by QS/contracts expert against real tender sets | `PRODUCTION_READINESS_AUDIT.md` F27; Doc §14 | `specs/901-post-audit-remaining-fixes.md` | blocked |
