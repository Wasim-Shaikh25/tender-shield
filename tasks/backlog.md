...
| TS-013a | Per-module SQLAlchemy models + migrations (auth slice DONE (orgs/users/org_members/refresh_tokens + migration 0001); ingestion/risk/boq/drafting/review/billing pending) | Doc §3.2 | `specs/data-model.md` | todo |
