...
| TS-013a | Per-module SQLAlchemy models + migrations (auth (0001) + ingestion (0002-0004) + findings (0005) + audit_log (0006) + artifacts (0007) DONE; risk persists, review + drafting wired; boq write-through + billing pending) | Doc §3.2 | `specs/data-model.md` | todo |
